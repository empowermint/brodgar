...
<div className="bio">
  ...
  <Image src={imgSteph} alt="Stephanie Green" />
...
<div className="bio">
  ...
  <Image src={imgSonja} alt="Sonja Heyer" />
...
<div className="bio">
  ...
  <Image src={imgIngrid} alt="Ingrid Leonard" className="bio-img" />
...
<Image src={imgLucy} alt="Lucy Alsop" className="bio-img" />
