...
<div className="bio">
  ...
  <div><Image src={imgSteph} alt="Stephanie Green" sizes="(min-width: 25rem) 12em, 100vw" /></div>
...
<div className="bio">
  ...
  <div><Image src={imgSonja} alt="Sonja Heyer" sizes="(min-width: 25rem) 12em, 100vw" /></div>
...
<div className="bio">
  ...
  <div><Image src={imgIngrid} alt="Ingrid Leonard" sizes="(min-width: 25rem) 12em, 100vw" /></div>
...
<div className="bio">
  ...
  <div><Image src={imgLucy} alt="Lucy Alsop" sizes="(min-width: 25rem) 12em, 100vw" /></div>
