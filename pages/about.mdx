...
export const meta = {
  title: "About",
  description: "Learn more about Rewilding: Brodgar Umbrella Poetry/Sound Walk"
}
...
**Rewilding: Brodgar Umbrella Poetry/Sound Walk** is a new multimedia installation centred on recordings of original poetry by poet Stephanie Green and natural sound recordings (wind, waves, birdsong) by sound artist, Sonja Heyer, plus some percussion, piano and song.  You can listen to recordings through your own headphones or inside  an optional  sound umbrella as you go on a walk, starting at the iconic Neolithic stonehenge, the Ring of Brodgar,  walk into the RSPB Brodgar Reserve down through a wildflower meadow to Loch Stenness, returning to feel the mystical power of the Ring of Brodgar or you can listen at home via this website.
...
Song in Verse 3 is 'Ariel's Song' composed by Thomas Arne (1710-1778) to words by Shakespeare in 'The Tempest'.

Piano extract in Verse 5 is from 'Farewell to Stromness' (1980) composed by Peter Maxwell Davis.
