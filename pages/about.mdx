...
<div className="logos">
  <span className="invert-if-dark-mode">
    <a href="https://www.creativescotland.com/">
      <Image src={logoCreativeScotland} alt="Creative Scotland logo" />
    </a>
  </span>
  <span className="bg-if-dark-mode">
    <a href="https://www.historicenvironment.scot/">
      <Image src={logoHES} alt="Historic Environment Scotland logo" />
    </a>
  </span>
  <span className="bg-if-dark-mode">
    <a href="https://www.rspb.org.uk/">
      <Image src={logoRSPB} alt="Royal Society for the Protection of Birds logo" />
    </a>
  </span>
  <span>
    <a href="https://www.historicenvironment.scot/learn/ranger-service/">
      <Image src={logoRangers} alt="Historic Scotland Rangers Service logo" />
    </a>
  </span>
</div>
